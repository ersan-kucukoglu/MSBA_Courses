...
keyTable <- read.csv("kucukoglu_ersan@student.ceu.edu_accessKeys.csv", header = T)
...
api_key <- "DjjxOzfBmG8IMGQMAUlmzJPrE"
api_secret <- "RkJuri9Bnk2N6NrGuh4jTHqib6BSIuFeVVqgdZKNn0TS9CQqaY"
access_token <- "449573277-tipuWqafBhpT7b3iDrcoIl9fCmdsLGEW5Umw8btM"
access_token_secret <- "UtslWKXqNpsdghz59ghqY76gR3LSBrNY2UpdKBYH1dFL9"
